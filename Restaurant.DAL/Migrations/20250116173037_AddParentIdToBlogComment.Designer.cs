...
namespace Restaurant.DAL.Migrations
{
    ...
    [Migration("20250116173037_AddParentIdToBlogComment")]
    partial class AddParentIdToBlogComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurant.Core.Entities.BlogComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurant.Core.Entities.Comment", b =>
                {
                    ...
                    b.ToTable("Comments", t =>
                        {
                            t.HasCheckConstraint("CK_Comment_Rating_Range", "[Rating] >= 0 AND [Rating] <= 5")
                                .HasName("CK_Comment_Rating_Range1");
                        });
                });
            ...
            modelBuilder.Entity("Restaurant.Core.Entities.BlogComment", b =>
                {
                    ...
                    b.HasOne("Restaurant.Core.Entities.BlogComment", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Restaurant.Core.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Restaurant.Core.Entities.Comment", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
