        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Contact_Email", "Email LIKE '%@%' AND Email LIKE '%.%'");
                    table.CheckConstraint("CK_Contact_Phone", "Phone LIKE '+%' AND LEN(Phone) >= 10 AND LEN(Phone) <= 15");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Contact_Email1", "Email LIKE '%@%' AND Email LIKE '%.%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogDetails_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
        ...
        table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredients_ProductDetails_ProductDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientDetails_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogDetails_LanguageId_BlogId",
                table: "BlogDetails",
                columns: new[] { "LanguageId", "BlogId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientDetails_LanguageId_IngredientId",
                table: "IngredientDetails",
                columns: new[] { "LanguageId", "IngredientId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_ProductDetailId",
                table: "Ingredients",
